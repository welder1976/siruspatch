...
function CreateCircularBuffer(maxElements, elements)
	local circularBuffer = elements or {}
	Mixin(circularBuffer, CircularBufferMixin)
...
function CircularBufferMixin:Clear()
    self.headIndex = self.headIndex or 0

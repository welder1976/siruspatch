...
function HelpTip:Show(parent, info, relativeRegion)
	...
	frame.width = HelpTip.width + (info.extraWidth or 0) + (info.extraRightMarginPadding or 0);
...
function HelpTipTemplateMixin:Layout()
	...
	local textOffsetY = 1;
	local textWidth = HelpTip.defaultTextWidth + (self.info and self.info.extraWidth or 0);

...
local HonorBarColors = {
	[PLAYER_FACTION_GROUP.Horde] = CreateColor(0.63, 0.09, 0.09),
	[PLAYER_FACTION_GROUP.Alliance] = CreateColor(0.05, 0.15, 0.36),
...
function HonorFrame_Update(updateAll)
	...
	local function UpdateFaction()
		...
		if color then
			HonorFrameProgressBar:SetStatusBarColor(color.r, color.g, color.b)
		end
	end

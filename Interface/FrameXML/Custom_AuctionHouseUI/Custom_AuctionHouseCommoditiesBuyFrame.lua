...
AuctionHouseCommoditiesBuyButtonMixin = CreateFromMixins(ButtonWithDisableMixin);
...
AuctionHouseCommoditiesBuyDisplayMixin = CreateFromMixins(LayoutMixin, VerticalLayoutMixin, AuctionHouseBackgroundMixin);
...
function AuctionHouseCommoditiesBuyDisplayMixin:OnShow()
	self:RegisterCustomEvent("COMMODITY_PURCHASE_SUCCEEDED");

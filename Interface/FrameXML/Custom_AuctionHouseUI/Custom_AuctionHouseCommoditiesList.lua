...
local AUCTION_HOUSE_COMMODITIES_LIST_CUSTOM_EVENTS = {
...
function AuctionHouseCommoditiesListMixin:OnLoad()
	...
	local function CommoditiesListRefreshResults()
		if self.itemID then
			self:GetAuctionHouseFrame():RefreshSearchResults(AuctionHouseSearchContext[self:GetAttribute("searchContext")], C_AuctionHouse.MakeItemKey(self.itemID));
		end
	end
...
function AuctionHouseCommoditiesListMixin:OnShow()
	...
	FrameUtil.RegisterFrameForCustomEvents(self, AUCTION_HOUSE_COMMODITIES_LIST_CUSTOM_EVENTS);
end

function AuctionHouseCommoditiesListMixin:OnHide()
	FrameUtil.UnregisterFrameForCustomEvents(self, AUCTION_HOUSE_COMMODITIES_LIST_CUSTOM_EVENTS);
end

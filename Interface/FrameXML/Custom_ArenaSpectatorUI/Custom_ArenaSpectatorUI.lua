...
function ezSpectator_Demo()
    ...
    worker:SetHealth(15000)
    worker:SetMaxPower(100)
    worker:Hide()

    _ezSpectator.Interface:SetMode(1)


    plate = ezSpectator_Nameplate:Create(_ezSpectator, _ezSpectator.Interface.TopFrame.MainFrame, 'CENTER', _ezSpectator.Interface.TopFrame.MainFrame, 'CENTER', -400, -100)

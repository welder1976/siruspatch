...
function ezSpectator_HealthBar:Create(Parent, DirectOrder, PersonalMode, FontSize, Width, Height, Scale, Point, RelativeFrame, RelativePoint, OffsetX, OffsetY)
    ...
    self.Overlay = CreateFrame('Frame', nil, ArenaSpectatorFrame)
    ...
    self.TextFrame = CreateFrame('Frame', nil, ArenaSpectatorFrame)
    ...
    self.Nickname:SetFont('Interface\\CustomFonts\\DejaVuSans.ttf', FontSize)
    ...
    self.Percent:SetFont('Interface\\CustomFonts\\DejaVuSans.ttf', FontSize)
    ...
    if PersonalMode then
        ...
        self.Description:SetFont('Interface\\CustomFonts\\DejaVuSans.ttf', 8)
        ...
        self.Description = self.TextFrame:CreateFontString(nil, 'OVERLAY')
        self.Description:SetFont('Interface\\CustomFonts\\DejaVuSans.ttf', 20)
        self.Description:SetTextColor(1, 1, 1, 0.75)
        self.Description:SetShadowColor(0, 0, 0, 0.75)
        self.Description:SetShadowOffset(1, -1)
    ...
    self.Override:SetFont('Interface\\CustomFonts\\DejaVuSans.ttf', 12)

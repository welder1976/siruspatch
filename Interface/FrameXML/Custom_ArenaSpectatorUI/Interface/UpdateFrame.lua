...
function ezSpectator_UpdateFrame:Create()
    ...
    self.Line1:SetFont('Interface\\CustomFonts\\DejaVuSansCondensed.ttf', 12, 'OUTLINE')
    self.Line1:SetTextColor(1, 0, 0, 1)
    self.Line1:SetPoint('TOP', 0, -8)

    self.Line2 = self.MainFrame:CreateFontString(nil, 'OVERLAY')
    self.Line2:SetFont('Interface\\CustomFonts\\DejaVuSansCondensed.ttf', 9, 'OUTLINE')
    ...
    self.Line3:SetFont('Interface\\CustomFonts\\DejaVuSansCondensed.ttf', 9, 'OUTLINE')
    ...
    self.Line4:SetFont('Interface\\CustomFonts\\DejaVuSansCondensed.ttf', 9, 'OUTLINE')
    ...
    self.LinkHolder:SetFont('Interface\\CustomFonts\\DejaVuSansCondensed.ttf', 12, 'OUTLINE')
    ...
    self.Line5:SetFont('Interface\\CustomFonts\\DejaVuSansCondensed.ttf', 9, 'OUTLINE')

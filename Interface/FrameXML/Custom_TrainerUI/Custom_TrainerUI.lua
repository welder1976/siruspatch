...
function GetMaxLearnableProfessions()
...
StaticPopupDialogs["CONFIRM_PROFESSION"] = {
	...
	OnShow = function(self)
		...
		local vipStatus 	= GetUnitVipStatus("player")
		...
		if vipStatus == 0 then
			self.HelpBox.Text:SetText(HELPBOX_VIP_PROFFESION)
			self.HelpBox:Show()
		else
			self.HelpBox:Hide()
		end
